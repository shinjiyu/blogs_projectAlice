...
function cc.exports.OnHandleData(pScene, nTag, nNetRet, lpData, lpExternal)
    ScutManager:execCallback(nTag, nNetRet, lpData,lpExternal)
end

cc.exports.ScutManager = class("ScutManager")

local loadingCache = {}--loading缓存
local callbackCache = {}--回调函数
local callTag = 0--调用的id递增
ScutManager.url = "192.168.2.113:9001"--服务器地址
