...
cc.exports.ZyRequestParam = {param = {}}
function ZyRequestParam:getParamData(nTag)
    return ZyRequestParam.param[nTag]
end
cc.exports.ZyRequestTag = 0
cc.exports.ZyReader = ScutDataLogic.CNetReader:getInstance()
cc.exports.ZyWriter = ScutDataLogic.CNetWriter:getInstance()

cc.exports.eScutNetSuccess = 0
cc.exports.
eScutNetError = 10000
...
function cc.exports.ZyExecRequest(pScutScene, lpData, addressPath)
